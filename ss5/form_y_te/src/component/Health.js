        ...
        <div className="container mt-5">
            ...
            >
                <Form className="border p-4 rounded shadow">
                    ...
                    <div className="mb-3">
                        <h5>Trong vòng 14 ngày qua, Anh/chị có đến quốc gia / vùng lãnh thổ nào (Có thể đi qua nhiều
                            quốc gia)</h5>
            ...
            {form && (
                <div className="mt-5 p-4 border rounded bg-light">
                    ...
                    <p><strong>Quận / huyện:</strong> {form.district}</p>
                    <p><strong>Phường / xã:</strong> {form.ward}</p>
                    <p><strong>Số nhà, phố, tổ dân phố / thôn / đội:</strong> {form.house}</p>
                    <p><strong>Điện thoại:</strong> {form.phone}</p>
                    <p><strong>Email:</strong> {form.email}</p>
                    <p><strong>Mô tả quốc gia / vùng lãnh thổ đã đến:</strong> {form.descrip}</p>
                    <p><strong>Dấu hiệu xuất hiện:</strong> {form.token ? form.token.join(", ") : "Không có"}
                    </p>
                    <p><strong>Tiếp xúc với:</strong> {form.contact ? form.contact.join(", ") : "Không có"}</p>
                </div>
            )}
        </div>
    );
